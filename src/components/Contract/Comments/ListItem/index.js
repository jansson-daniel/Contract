...
export class ListItem extends Component {
    ...
    handleClick () {
        ...
        if (typeof this.props.comment.selectionRange.startContainer !== 'undefined') {
            ...
            window.scrollTo(this.props.comment.position.x, this.props.comment.position.y -100);
    ...
    render () {
        return (
            <li onClick={this.handleClick} className="list-item">
                <p className="sender-receiver">From <span className="sender">Peramanathan Sathyamoorthly</span> To <span className="receiver">Testing Ninja</span><span className="timestamp">27 minutes ago</span></p>
